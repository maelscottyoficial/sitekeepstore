      ...
      <main className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col">
            <span className="mb-2 inline-block w-fit rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1 text-xs font-semibold text-indigo-300">
              {product.category}
            </span>

            <h1 className="mb-4 text-2xl font-bold leading-tight text-white lg:text-3xl">
              {product.name}
            </h1>
            ...
            {/* Description */}
            <div className="mt-8 rounded-xl border border-white/5 bg-[#1a1a2e]/30 p-5">
